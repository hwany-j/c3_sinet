...
class SBNet_aux(nn.Module):
    ...
    def __init__(self,config, classes=20, p=2, q=3, chnn=1.0, encoderFile=None,):
        ...
        self.level3_C = CBR(dim2, classes, 1, 1)
...
def Dnc_SINaux(classes, p, q, chnn, encoderFile=None):
    #
    config = [[[3, 1], [5, 1]], [[3, 0], [3, 1]], [[3, 0], [3, 1]],
              [[3, 1], [5, 1]], [[3, 0], [3, 1]], [[5, 1], [5, 4]], [[3, 2], [5, 8]], [[3, 1], [5, 1]],
              [[3, 1], [5, 1]], [[3, 0], [3, 1]], [[5, 1], [5, 8]], [[3, 2], [5, 4]], [[3, 0], [5, 2]]]
    ...
    model = SBNet_aux(config, classes=classes, p=p, q=q, chnn=chnn, encoderFile=encoderFile)
    return model
