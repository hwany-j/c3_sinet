...
class LoadData:
    ...
    def compute_class_weights(self, histogram):
        ...
        # histogram[-1] = 0
        # print("after make 0 histogram " + str(histogram))
        # normHist = histogram / np.sum(histogram[:-1])
    ...
    def processData(self):
        ...
        if return_val ==0 and return_val1 ==0:
            ...
            print("num of trainSet : " + str(len(self.trainImList)))
            print("num of trainSet : " + str(len(self.valImList)))
